 ...
 * la calculadora.
 * Debe contener un método público de instancia por cada método de la interfaz
 * CalculadoraGUI.ICalculadora.
 * Para evitar confusiones, se recomienda que cada uno de los métodos citados
 * anteponga 'implementacion' al
 * nombre del método de CalculadoraGUI.ICalculadora. Por ejemplo: si se desea
 * crear el método que implementa
